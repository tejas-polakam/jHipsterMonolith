...
describe('Service Tests', () => {
  describe('Stocks Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(StocksService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Stocks(0, 'AAAAAAA', 0, 0, 0, 0, 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Stocks', async () => {
      ...
      it('should update a Stocks', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            open: 1,
      ...
      it('should delete a Stocks', async () => {
