...
public class AuthorCriteria implements Serializable, Criteria {
    ...
    private LongFilter onetomanyId;
    ...
    public AuthorCriteria(AuthorCriteria other){
        ...
        this.onetomanyId = other.onetomanyId == null ? null : other.onetomanyId.copy();
    }
    ...
    public LongFilter getOnetomanyId() {
        return onetomanyId;
    }

    public void setOnetomanyId(LongFilter onetomanyId) {
    ...
    public boolean equals(Object o) {
        ...
        return
            ...
            Objects.equals(onetomanyId, that.onetomanyId);
    }
    ...
    public String toString() {
        return "AuthorCriteria{" +
                ...
                (onetomanyId != null ? "onetomanyId=" + onetomanyId + ", " : "") +
            "}";
    }
